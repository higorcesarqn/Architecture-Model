...
namespace Infra.EntityFramework.UnitOfWork
{
    /// <summary>
    ...
    public class UnitOfWork<TContext> : IRepositoryFactory, IUnitOfWork<TContext>, IUnitOfWork where TContext : DbContext
    {
        ...
        public Task<int> ExecuteSqlCommand(string sql, params object[] parameters) => _context.Database.ExecuteSqlRawAsync(sql, parameters);
        ...
        {
            GetCurrentTransaction ??= await _context.Database.BeginTransactionAsync(System.Data.IsolationLevel.ReadCommitted);
        }
